...
\restrict Y26T8uJjgJVDTHv6ZFkBHQWy0AJsSYzHMyRHbbDg96h1cCCFhT4YZ3eqjoUpq1N
...
--
-- Name: aircrafts_data aircrafts_data_pkey; Type: CONSTRAINT; Schema: bookings; Owner: -
--
...
ALTER TABLE ONLY bookings.boarding_passes
    ADD CONSTRAINT boarding_passes_ticket_no_flight_id_fkey FOREIGN KEY (ticket_no, flight_id) REFERENCES bookings.ticket_flights(ticket_no, flight_id);
...
\unrestrict Y26T8uJjgJVDTHv6ZFkBHQWy0AJsSYzHMyRHbbDg96h1cCCFhT4YZ3eqjoUpq1N
